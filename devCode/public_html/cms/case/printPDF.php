...
$recScopeName = '';
$caseTypeClientName = "";
if (isset($_SESSION['caseTypeClientList'][$caseRow['caseType']])) {
...
$region = $caseRow[4];
$regionName = fGetRegionName($region);
$deptName = fGetDepartmentName($caseRow[5]); // SWAP OUT WITH ASSOC
...
<table align="center" cellpadding="0" cellspacing="5" width="100%">
    <tr>
        <td align="center" valign="top">
            <img src="<?php echo $sitepath; ?>dashboard/clientlogos/<?php echo $_SESSION['logoFileName']?>"
                hspace="0" vspace="0" class="logoSize" /><br /><br />
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="center"><b><?php echo $_SESSION['regionTitle']; ?>:</b> <?php echo $regionName; ?></td>
    </tr>
    <tr>
        <td align="center"><b><?php echo $_SESSION['departmentTitle']; ?>:</b> <?php echo $deptName; ?></td>
    </tr>
    <tr>
        <td align="center"><b>Scope:</b> <?php echo $caseTypeClientName?></td>
    </tr>
<?php if ($recScopeName) { ?>
    <tr>
        <td align="center">Recommended: <?php echo $recScopeName?></td>
    </tr>
<?php } ?>
    <tr>
...
<?php if ($tpRow && $_SESSION['b3pRisk'] && $tpRow->risk) { ?>
    <tr>
        <td align="center"><b>Risk rating:</b> <?php echo $tpRow->risk; ?></td>
    </tr>
<?php } ?>
</table>
</div>
...
if ($accCls->allow('accCasePersonnel')
    ...
    ?>
    <!--NewPage-->
    <p class="pgbrk sect">Personnel</p>
    <hr width="100%" size="1" noshade="noshade" />
    <?php
    include "caseFolderPages/personnel.sec";
}
if ($_SESSION['bDDQcreated']
    ...
    // The next 2 tabs only apply if the case originated from a DDQ
    if ($accCls->allow('accCaseBizPrac')) {
        ?>
        <!--NewPage-->
        <p class="pgbrk sect">Business Practices</p>
        <hr width="100%" size="1" noshade="noshade" />
        <?php
        include "caseFolderPages/bizprac.sec";
    }
    if ($accCls->allow('accCaseRelation')
        ...
        <hr width="100%" size="1" noshade="noshade" />
        <?php
        include "caseFolderPages/relationships.sec";
    }
}
