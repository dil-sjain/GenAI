<?php
/**
 * Control for TPM Fields/Lists - Billing Unit
 */
...
/**
 * Class BillingUnit controls the Billing Unit requirements. This class depends on being
 * called via the FieldsLists controller.
 *
 * @keywords billing unit, tpm, fields lists, content control, settings, custom lists
 */
class BillingUnit extends TpmLists
{
    /**
    ...
    public function __construct($tenantID, $listTypeID, $userID, $initValues = [])
    {
        ...
        $this->data = new BillingUnitData($this->tenantID, $this->userID, $this->listTypeID);
    ...
    /**
     * Class uses parent TpmList methods add/update/remove
     */
}
