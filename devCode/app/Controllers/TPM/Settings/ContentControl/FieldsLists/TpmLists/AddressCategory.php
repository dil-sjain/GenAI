<?php
/**
 * Control for TPM Fields/Lists - Address Categories
 */
...
use Models\TPM\Settings\ContentControl\FieldsLists\TpmLists\AddressCategoryData;

/**
 * Class AddressCategory controls the Address Category requirements. This class depends on being
 * called via the FieldsLists controller.
 *
 * @keywords address categories, tpm, fields lists, content control, settings, custom lists
 */
class AddressCategory extends TpmLists
{
    /**
    ...
    public function __construct($tenantID, $listTypeID, $userID, $initValues = [])
    {
        ...
        $this->data = new AddressCategoryData($this->tenantID, $this->userID, $this->listTypeID);
