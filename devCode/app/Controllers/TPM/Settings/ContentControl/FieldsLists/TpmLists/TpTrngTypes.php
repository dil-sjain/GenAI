<?php
/**
 * Control for TPM Fields/Lists - Training Types
 */
...
use Models\TPM\Settings\ContentControl\FieldsLists\TpmLists\TpTrngTypesData;

/**
 * Class TpTrngTypes controls the Training Type requirements. This class depends on being
 * called via the FieldsLists controller.
 *
 * @keywords training types, tpm, fields lists, content control, settings, custom lists
 */
#[\AllowDynamicProperties]
class TpTrngTypes extends TpmLists
{
    /**
    ...
    public function __construct($tenantID, $listTypeID, $userID, $initValues = [])
    {
        ...
        $this->data = new TpTrngTypesData($this->tenantID, $this->userID, $this->listTypeID);
