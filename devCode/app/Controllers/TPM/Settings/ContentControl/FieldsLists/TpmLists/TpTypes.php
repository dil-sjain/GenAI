<?php
/**
 * Control for TPM Fields/Lists - 3P Types
 */
...
class TpTypes extends TpmLists
{
    ...
    public function __construct($tenantID, $listTypeID, $userID, $initValues = [])
    {
        ...
        $this->data = new TpTypesData($this->tenantID, $this->userID, $this->listTypeID);
