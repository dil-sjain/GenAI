<?php
/**
 * Control for TPM Fields/Lists - Note Categories
 */
...
use Models\TPM\Settings\ContentControl\FieldsLists\TpmLists\NoteCatsData;

/**
 * Class NoteCats controls the Note Category requirements. This class depends on being
 * called via the FieldsLists controller.
 *
 * @keywords note categories, tpm, fields lists, content control, settings, custom lists
 */
#[\AllowDynamicProperties]
class NoteCats extends TpmLists
{
    /**
    ...
    public function __construct($tenantID, $listTypeID, $userID, $initValues = [])
    {
        ...
        $this->data = new NoteCatsData($this->tenantID, $this->userID, $this->listTypeID);
