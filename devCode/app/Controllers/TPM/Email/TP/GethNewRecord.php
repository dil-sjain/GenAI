...
class GethNewRecord extends GethEmail
{
    /**
    ...
    {
        $this->setEmType(SysEmail::EMAIL_GETH_NEW_RECORD);
    ...
    public function getDefaultEmail()
    {
        ...
        $email->setSubject('A new Gift Record has been submitted');

        $body  = 'Hello <name>,' . PHP_EOL . PHP_EOL;
        $body .= "\t" . 'A new Gifts and Entertainment record has been created. Details are as follows:'
            . PHP_EOL . PHP_EOL;
